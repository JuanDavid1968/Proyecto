...
if(isset($_POST["id_dir"]) && !empty($_POST["id_dir"])){
    ...
    if(empty($empleado_err) && empty($direccion_err)){
        // Prepare an update statement
        $sql = "UPDATE direcciones SET id_emp=?, direccion = ? WHERE id_dir=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sss", $param_empleado, $param_direccion ,$param_id);
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Actualizar Registro de Direcciones</h2>
                    </div>
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <input type="hidden" name="id_dir" value="<?php echo $id; ?>"/>
