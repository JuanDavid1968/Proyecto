            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["nombre_art"]; ?></p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["descripcion_art"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Precio del Articulo</label>
                        <p class="form-control-static"><?php echo $row["precio_art"]; ?></p>
                    </div>
