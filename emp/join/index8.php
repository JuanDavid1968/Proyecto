        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM empleados INNER JOIN bodega ON empleados.id_bod=bodega.id_bod INNER JOIN cargo ON empleados.id_emp=cargo.id_emp WHERE empleados.id_bod = 10002;";
